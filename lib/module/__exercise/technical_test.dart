...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      String priceing = price.toString();

      return priceing is String;
    },
    ...
    */
    ...
    () {
      ...
      bool? output =
          normalizedInput == normalizedInput.split('').reversed.join();
    ...
    () {
      ...
      int? output = -1;
      output = numbers.reduce((a, b) => a > b ? a : b);
      return output == 5;
    },
    ...
    () {
      ...
      numbers.sort();
      bool output = numbers[0] == 1 && numbers[4] == 5;
    ...
    () {
      ...
      bool output = numbers[0] == 5 && numbers[4] == 1;
    ...
    () {
      ...
      bool isMatch = output == " is awesome";
      return output == " is awesome";
    },
    ...
    () {
      ...
      List<String>? baru = [];
      baru = text.split(" ");
      return baru.toString() == '[Dart, is, awesome]';
    },
    ...
    () {
      ...
      double? output = 0;
      output = numbers.reduce((a, b) => a + b) / numbers.length;
    ...
    () {
      ...
      bool? output = false;
      output = numbers.any((number) => number % 2 == 0);
      return output;
    },
    ...
    () {
      ...
      int? output = -1;
      output = numbers.indexWhere((number) => number % 2 == 0);
      return output == 1;
    },
    ...
    () {
      ...
      if (sales.length > 0) {
        salesAverage = salesTot / sales.length;
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var transaction in data) {
        if (transaction["transaction"] == "Sale" && transaction["amount"] > 0) {
          totalSales += (transaction["amount"] as int);
    ...
    () {
      ...
      for (var employee in data) {
        totalSalary += employee["hoursWorked"] * employee["hourlyRate"] as int;
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var tot in products) {
        totalHarga += tot["price"];
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var penda in transactions) {
        totalPendapatan += penda["amount"] * penda["price"];
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var gaji in employees) {
        totalGaji += gaji["salary"];
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var total in orders) {
        totalNilaiPemesanan += total["quantity"] * total["price"];
      }
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var nilai in shipments) {
        if (nilai["shippingCost"] > maxBiayaPengiriman) {
          maxBiayaPengiriman = (nilai["shippingCost"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var absen in attendance) {
        if (absen["isPresent"] == true) {
          jumlahHadir += 1;
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var stock in warehouse) {
        if (stock["stock"] > maxStok) {
          maxStok = (stock["stock"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var hadir in employeeAttendance) {
        if (hadir["isPresent"] == true) {
          hadirOnly.add(hadir);
        }
      }
      ...
      return hadirOnly.length == 2 && hadirOnly[0]["name"] == "John";
    },
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var sis in studentScores) {
        totalScore += (sis["score"]);
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var rata in employees) {
        averageAge += (rata["age"] / employees.length);
      }
    ...
    () {
      ...
      for (var produk in products) {
        if (produk["price"] > maxPrice) {
          maxPrice = (produk["price"]);
        } else if (produk["price"] < minPrice) {
          minPrice = (produk["price"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var laris in products) {
        if (laris["quantitySold"] > maxQuantitySold) {
          maxQuantitySold = (laris["quantitySold"]);
          bestProduct = (laris["name"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var kpi in employees) {
        if (kpi["kpi"] < 80) {
          lowPerformers.add(kpi["name"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var absen in employees) {
        if (absen["absentDays"] < minAbsentDays) {
          minAbsentDays = (absen["absentDays"]);
          bestEmployee = (absen["name"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var produk in products) {
        if (produk["soldInDays"] > maxSoldInDays) {
          maxSoldInDays = (produk["soldInDays"]);
          bestProduct = (produk["name"]);
        }
      }
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (var usia in employees) {
        if (usia["age"] > 30 || usia["gender"] == "female") {
          name = (usia["name"]);
          age = (usia["age"]);
          gender = (usia["gender"]);
        }
    ...
    () {
      ...
      // Kemudian masukkan data karyawan tersebut ke dalam list matchedEmployees
      // >>> Tulis kode for loop di sini\
      for (var kerja in employees) {
        if (kerja["age"] > 35 || kerja["name"].contains("Smith")) {
          matchedEmployees.add(kerja);
        }
      }
